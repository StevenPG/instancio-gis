...
/**
 * Generator Spec for generating a PackedCoordinateSequence.
 *
 * @since 1.0.0
 */
public interface PackedCoordinateSequenceGeneratorSpec extends GeneratorSpec<PackedCoordinateSequence> {

    /**
     * Generate a valid coordinate
     *
     * @param coordinateSequence the coordinate sequence to generate
     * @return spec builder
     * @since 1.0.0
     */
    PackedCoordinateSequenceGeneratorSpec coordinateSequence(List<Coordinate> coordinateSequence);
     ...
     * @param min the minimum number of coordinates, must be >= 1
     * @param max the maximum number of coordinates, must be >= min
     * @return spec builder
     */
