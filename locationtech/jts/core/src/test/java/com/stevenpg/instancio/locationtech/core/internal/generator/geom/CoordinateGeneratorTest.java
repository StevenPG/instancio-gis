...
class CoordinateGeneratorTest {
    ...
    @RepeatedTest(5)
    void latitude() {
        var coordinate = new CoordinateGenerator().latitude(10d).generate(null);
        assertNotNull(coordinate);
        assertTrue(coordinate.x > -180 && coordinate.x < 180);
        assertTrue(coordinate.y > -90 && coordinate.y < 90);
    ...
    @RepeatedTest(5)
    void longitude() {
        var coordinate = new CoordinateGenerator().longitude(20d).generate(null);
        assertNotNull(coordinate);
        assertTrue(coordinate.x > -180 && coordinate.x < 180);
        assertTrue(coordinate.y > -90 && coordinate.y < 90);
    ...
    @RepeatedTest(5)
    void generate() {
        var coordinate = new CoordinateGenerator().generate(null);
        assertNotNull(coordinate);
        assertTrue(coordinate.x > -180 && coordinate.x < 180);
        assertTrue(coordinate.y > -90 && coordinate.y < 90);
        assertTrue(Double.isNaN(coordinate.z));
